----------------------Monstros-----------------------------
    ...
    INSERT INTO inimigo (nome, poder)
    VALUES('Dragão de plutônio', 20);

    INSERT INTO inimigo (nome, poder)
    VALUES('Polvozilla', 18);

    INSERT INTO inimigo (nome, poder)
    VALUES('Balrog', 18);

    INSERT INTO inimigo (nome, poder)
    VALUES('Tíbio e Perônio', 16);

    INSERT INTO inimigo (nome, poder)
    VALUES('Rei Tut', 16);

    INSERT INTO inimigo (nome, poder)
    VALUES('Hipopógrifo', 16);

    INSERT INTO inimigo (nome, poder)
    VALUES('Horror Aterrorizante Indiscritivelmente Indescritível', 14);

    INSERT INTO inimigo (nome, poder)
    VALUES('Golem de (os que fumam a) Pedra', 14);

    INSERT INTO inimigo (nome, poder)
    VALUES('Vendedor de Seguros', 14);

    INSERT INTO inimigo (nome, poder)
    VALUES('Pé Grande', 12);

    INSERT INTO inimigo (nome, poder)
    VALUES('Demônia Linguaruda', 12);

    INSERT INTO inimigo (nome, poder)
    VALUES('Paga Pau de Vampiro', 12);

    INSERT INTO inimigo (nome, poder)
    VALUES('3.872 Orcs', 10);

    INSERT INTO inimigo (nome, poder)
    VALUES('Troll da Internet', 10);

    INSERT INTO inimigo (nome, poder)
    VALUES('Nariz Flutuante', 10);

    INSERT INTO inimigo (nome, poder)
    VALUES('Chupa Cara', 8);

    INSERT INTO inimigo (nome, poder)
    VALUES('Noivampiras', 8);

    INSERT INTO inimigo (nome, poder)
    VALUES('Amazona', 8);

    INSERT INTO inimigo (nome, poder)
    VALUES('Coreto Aterrorizante', 8);

    INSERT INTO inimigo (nome, poder)
    VALUES('Advogados', 6);

    INSERT INTO inimigo (nome, poder)
    VALUES('Nerd Histérico', 6);

    INSERT INTO inimigo (nome, poder)
    VALUES('Manticornitorrinco', 6);

    INSERT INTO inimigo (nome, poder)
    VALUES('Gorfomón', 6);

    INSERT INTO inimigo (nome, poder)
    VALUES('Duende Leproso', 4);

    INSERT INTO inimigo (nome, poder)
    VALUES('Lesmas Velozes', 4);

    INSERT INTO inimigo (nome, poder)
    VALUES('Harpias', 4);

    INSERT INTO inimigo (nome, poder)
    VALUES('Cavalo Zumbi', 4);

    INSERT INTO inimigo (nome, poder)
    VALUES('Pit Bull', 2);

    INSERT INTO inimigo (nome, poder)
    VALUES('Octaedro Gelatinoso', 2);

    INSERT INTO inimigo (nome, poder)
    VALUES('Rãs Voadoras', 2);

    INSERT INTO inimigo (nome, poder)
    VALUES('João do Caixão', 2);

    INSERT INTO inimigo (nome, poder)
    VALUES('Galinha Anabolizada', 2);

    INSERT INTO inimigo (nome, poder)
    VALUES('Gosma Grudenta', 1);

    INSERT INTO inimigo (nome, poder)
    VALUES('Carrapatos', 1);

    INSERT INTO inimigo (nome, poder)
    VALUES('Vaso de Planta', 1);

    INSERT INTO inimigo (nome, poder)
    VALUES('Ratricinha com Porrete', 1);

    INSERT INTO inimigo (nome, poder)
    VALUES('Goblin Aleijado', 1);
