...
CREATE TABLE IF NOT EXISTS jogador (
    ...
    PRIMARY KEY (personagem_id),
    CONSTRAINT fk_cabeca FOREIGN KEY(cabeca_id) REFERENCES equipamento(fk_equip),
    CONSTRAINT fk_arma FOREIGN KEY(arma_id) REFERENCES equipamento(fk_equip),
    CONSTRAINT fk_armadura FOREIGN KEY(armadura_id) REFERENCES equipamento(fk_equip),
    CONSTRAINT fk_pes FOREIGN KEY(pes_id) REFERENCES equipamento(fk_equip),
    CONSTRAINT fk_missao FOREIGN KEY(missao_id) REFERENCES missao(missao_id),
    CONSTRAINT fk_sala_atual FOREIGN KEY(sala_id) REFERENCES sala(sala_id)
);
--Inimigos
